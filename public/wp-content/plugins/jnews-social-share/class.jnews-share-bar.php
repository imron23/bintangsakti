...
class JNews_Share_Bar {
	...
	protected function build_button( $social, $text = '' ) {
		...
		if ( $social === 'twitter' ) {
			$svg    = jnews_get_svg( 'twitter' );
			$button = "<a href=\"{$button_url}\" rel='nofollow' {$additional_attribute} class=\"{$button_class} {$expanded}\"><i class=\"{$icon_class}\">" . $svg . "</i>$sharetext</a>";
		} elseif ( $social === 'line' ) {
			$svg    = jnews_get_svg( 'line' );
			$button = "<a href=\"{$button_url}\" rel='nofollow' {$additional_attribute} class=\"{$button_class} {$expanded}\"><i class=\"{$icon_class}\">" . $svg . "</i>$sharetext</a>";
		} else {
	...
	protected function build_bottom_button( $social ) {
		...
		if ( $social === 'twitter' ) {
			$svg    = jnews_get_svg( 'twitter' );
			$button = "<a href=\"{$button_url}\" rel='nofollow' class=\"{$button_class} expanded\"><i class=\"{$icon_class}\">" . $svg . "</i>{$sharetext}</a>";
		} elseif ( $social === 'line' ) {
			$svg    = jnews_get_svg( 'line' );
			$button = "<a href=\"{$button_url}\" rel='nofollow' class=\"{$button_class} expanded\"><i class=\"{$icon_class}\">" . $svg . "</i>{$sharetext}</a>";
		} else {
