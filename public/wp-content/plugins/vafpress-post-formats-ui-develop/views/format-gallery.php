<div id="vp-pfui-format-gallery-preview" class="vp-pfui-elm-block vp-pfui-elm-block-image" style="display: none;">
	<label><span><?php _e('Gallery Images', 'vafpress-post-formats-ui-develop'); ?></span></label>
	<div class="vp-pfui-elm-container">
		...
		<div class="vp-pfui-gallery-picker">
			...
			<p class="none"><a href="#" class="button vp-pfui-gallery-button"><?php _e('Pick Images', 'vafpress-post-formats-ui-develop'); ?></a></p>
		</div>
