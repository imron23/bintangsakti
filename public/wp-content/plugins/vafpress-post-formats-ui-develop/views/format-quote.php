<div id="vp-pfui-format-quote-fields" style="display: none;">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-name"><?php _e('Source Name', 'vafpress-post-formats-ui-develop'); ?></label>
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-url"><?php _e('Source URL', 'vafpress-post-formats-ui-develop'); ?></label>
