...
### <?php esc_html_e('WordPress Environment', 'jnews'); ?> ###

<?php do_action('jnews_system_status_wordpress_environment', false); ?>


### <?php esc_html_e('Server Environment', 'jnews'); ?> ###
...
### <?php esc_html_e('End', 'jnews'); ?> ###
    ...
    <table class="jnews_admin_table widefat" cellspacing="0" id="status">
        <thead>
        <tr>
            <th colspan="3"><?php esc_html_e( 'WordPress Environment', 'jnews' ); ?></th>
        </tr>
        </thead>
        <tbody>
            <?php do_action('jnews_system_status_wordpress_environment', true); ?>
        </tbody>
    </table>
    ...
    <table class="jnews_admin_table widefat" cellspacing="0" id="status">
        <thead>
        <tr>
            <th colspan="3"><?php esc_html_e( 'Server Environment', 'jnews' ); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php do_action('jnews_system_status_server_environment', true); ?>
        </tbody>
    </table>
