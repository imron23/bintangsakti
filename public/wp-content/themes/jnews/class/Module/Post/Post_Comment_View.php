...
Class Post_Comment_View extends PostViewAbstract
{
    public function render_module_back($attr, $column_class)
    {
        ...
        ob_start();
        comments_template();
        return "<div {$this->element_id($attr)} class='jnews_comment_container jeg_custom_comment_wrapper {$attr['scheme']} {$attr['el_class']} {$this->get_vc_class_name()}'>" . ob_get_clean() . "</div>";
    }
